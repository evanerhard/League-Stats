...
class CompareForm(forms.Form):
    ...
    full_name_1 = forms.CharField(label = "Enter First Player Name:",
        required=True,
        max_length=255,
        strip = True
        )
    full_name_2 = forms.CharField(label = "Enter Second Player Name:",
        required=True,
        max_length=255,
        strip = True
        )
